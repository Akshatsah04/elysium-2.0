            ...
            <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div>
                    <motion.button
                        ...
                        className="px-4 py-2 border border-primary/50 text-primary text-sm uppercase tracking-wider font-body hover:bg-primary/10 transition-all rounded-sm mx-5"
                    >
                        Contact us
                    </motion.button>
                    <motion.button
